...
import { FiX, FiCheck, FiCalendar, FiMapPin, FiClock } from "react-icons/fi";
...
const AcceptWalkModal = ({ isOpen, onClose, onConfirm, walkData, isLoading }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="relative overflow-hidden rounded-3xl bg-white/90 dark:bg-foreground/90 backdrop-blur-sm shadow-xl border border-success/10 max-w-md w-full mx-4">
                ...
                <div className="relative p-6">
                    <div className="flex items-center mb-6">
                        <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-green-600 rounded-full flex items-center justify-center mr-4 shadow-lg flex-shrink-0">
                            <FiCheck className="text-white text-xl" />
                        </div>
                        <div className="flex-1 min-w-0">
                            <h3 className="text-xl font-bold text-foreground dark:text-background mb-1">
                                Aceptar Solicitud de Paseo
                            </h3>
                    ...
                    {walkData && (
                        <div className="relative overflow-hidden rounded-2xl bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm shadow-lg border border-success/10 mb-6">
                    ...
                    <div className="mb-6">
                        ...
                        <p className="text-sm text-center text-accent dark:text-muted">
                            Una vez aceptada, el cliente recibirá una notificación y deberá proceder con el pago para confirmar el servicio.
                        </p>
                    </div>
