...
import { FiX, FiPlay, FiCalendar, FiMapPin, FiClock } from "react-icons/fi";
            ...
            <div className="relative overflow-hidden rounded-3xl bg-white/90 dark:bg-foreground/90 backdrop-blur-sm shadow-xl border border-primary/10 max-w-md w-full mx-4">
                ...
                <div className="relative p-6">
                    <div className="flex items-center mb-6">
                        <div className="w-12 h-12 bg-gradient-to-br from-primary to-blue-600 rounded-full flex items-center justify-center mr-4 shadow-lg flex-shrink-0">
                    ...
                    {walkData && (
                        <div className="relative overflow-hidden rounded-2xl bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm shadow-lg border border-primary/10 mb-6">
                            ...
                            <div className="absolute top-3 right-3 z-10">
                                <span className="px-2 py-1 rounded-full text-xs font-bold shadow-lg bg-yellow-500/70 text-black">
                                    Confirmado
                                </span>
                            </div>
                                ...
                                <div className="flex items-center mb-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex items-center text-accent dark:text-muted">
                                            ...
                                            <span className="text-xs font-medium truncate">Pago confirmado</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-primary/10 dark:from-blue-900/20 dark:to-primary/20 rounded-2xl p-4 border border-primary/20 mb-6">
                        <div className="flex items-center mb-3">
                            <FiPlay className="text-primary mr-2" size={18} />
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-sm text-foreground dark:text-background">
                                ⏱️ Se registrará automáticamente el tiempo de inicio
                            </p>
                        </div>
                    </div>
