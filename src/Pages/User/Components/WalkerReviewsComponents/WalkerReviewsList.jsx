import { FiStar, FiCalendar, FiUser, FiHeart } from "react-icons/fi";
import { format } from "date-fns";
import { es } from "date-fns/locale";

const WalkerReviewsList = ({ reviews }) => {
    ...
    const getRatingIcon = (rating) => {
        if (rating >= 4) return <FiHeart className="w-4 h-4 text-red-500" />;
        return null;
    };
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-start justify-between">
                                ...
                                <div className="flex-shrink-0 flex items-center space-x-2">
                                    ...
                                    <span className="text-xs px-2 py-1 bg-primary/20 text-black rounded-full font-medium">
                                        Reseña recibida
                                    </span>
                                </div>
                            </div>
...
export default WalkerReviewsList;